		...
		<%
			...
			if (productList == null) {
				...
				while (iterator.hasNext()) {
					...
					out.print("<td align=\"center\"><input type=\"text\" name=\"newqty" + count
							+ "\" size=\"3\" value=\"" + product.get(3) + "\"></TD>");
					...
					out.println("<td>&nbsp;&nbsp;&nbsp;&nbsp;<a href=\"showcart.jsp?delete=" + product.get(0)
				...
				out.println("<td><td colspan=\"4\" align=\"right\"><b>Order Total</b></td>" + "<td align=\"right\">"
